    ...
    public function loadData(Request $request)
    {
        ...
        return Datatables::of($payment_inputs)
            ->addColumn('action', function ($payment_input) {
                ...
                $btn = $btn.' <a href="javascript:void(0)" data-toggle="tooltip"  data-id="'.$payment_input->id.'" data-original-title="Delete" class="btn btn-danger btn deleteItem"><i class="fas fa-times"></i></a>';
                return $btn;
