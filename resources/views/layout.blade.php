...
<head>
    ...
    <title>Controle Financeiro | @yield('title')</title>
...
<div class="wrapper">
  ...
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-white navbar-light"> {{-- navbar-purple navbar-dark --}}
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
  ...
  <aside class="main-sidebar sidebar-dark-purple elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <div class="brand-image img-circle elevation-3"><i class="material-icons" style="font-size: 32px;opacity: .8">monetization_on</i></div> 
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item">
                <a href="{{ route('descriptions.index')}}" class="nav-link {{ Request::url() == route('descriptions.index') ? 'active' : '' }}">
